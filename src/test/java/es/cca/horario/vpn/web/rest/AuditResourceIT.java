...
import es.cca.horario.vpn.config.audit.AuditEventConverter;
import es.cca.horario.vpn.domain.PersistentAuditEvent;
import es.cca.horario.vpn.repository.PersistenceAuditEventRepository;
import es.cca.horario.vpn.security.AuthoritiesConstants;
import es.cca.horario.vpn.service.AuditEventService;
