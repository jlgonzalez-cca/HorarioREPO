package es.cca.horario.vpn.web.rest;

import static es.cca.horario.vpn.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.cca.horario.vpn.HorarioVpnApp;
import es.cca.horario.vpn.config.Constants;
import es.cca.horario.vpn.domain.Authority;
import es.cca.horario.vpn.domain.User;
import es.cca.horario.vpn.repository.AuthorityRepository;
import es.cca.horario.vpn.repository.UserRepository;
import es.cca.horario.vpn.security.AuthoritiesConstants;
import es.cca.horario.vpn.service.UserService;
import es.cca.horario.vpn.service.dto.PasswordChangeDTO;
import es.cca.horario.vpn.service.dto.UserDTO;
import es.cca.horario.vpn.web.rest.vm.KeyAndPasswordVM;
import es.cca.horario.vpn.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = HorarioVpnApp.class)
